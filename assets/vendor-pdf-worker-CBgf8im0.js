...
`],{type:"application/javascript"})),{type:"module"});return e.postMessage({type:"wasmInit",wasmUrl:c,logger:n?P(n):void 0}),new h(e,n)}export{D as createPdfiumEngine};
